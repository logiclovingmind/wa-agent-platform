/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 678ce4108ad0be59cd7cd90ab910bb78)
// Runtime types generated with workerd@1.20260801.1 2025-05-01 
interface __BaseEnv_Env {
	ORG_LIMITER: RateLimit;
	SUPABASE_URL: "https://gtouimwbjfuzgotdqqan.supabase.co";
	DASHBOARD_ORIGIN: "https://app.logiclovingmind.com,https://wa-agent-dashboard.pages.dev";
	PUBLIC_API_ORIGIN: "https://wa-agent-api.wa-api.workers.dev";
	META_GRAPH_URL: "https://graph.facebook.com/v21.0";
	LLM_BASE_URL: "https://aicredits.in/v1";
	LLM_MODEL: "openai/gpt-4o-mini";
	CONVERSATION: DurableObjectNamespace<import("./src/index").ConversationDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConversationDO";
	}
