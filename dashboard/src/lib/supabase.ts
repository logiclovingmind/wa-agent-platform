...
/**
 * What to call this customer. The profile name is what the owner recognises; the number
 * is the fallback, in full and with its country code, because a truncated number is
 * useless for looking someone up.
 *
